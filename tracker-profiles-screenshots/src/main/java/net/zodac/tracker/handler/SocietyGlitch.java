...
/**
 * Implementation of {@link AbstractTrackerHandler} for the {@code SocietyGlitch} tracker.
 */
...
public class SocietyGlitch extends AbstractTrackerHandler {
     ...
     *
     * <p>
     * For {@link SocietyGlitch}, prior to clicking the login button with a successful username/password there is another field where a
    ...
    protected void preLoginClickAction() {
        ...
        // The default position blocks the user input, so we override it
        displayUtils.confirm(trackerDefinition.name(), "Solve the captcha", DialogPosition.of(0, 80));
    }
