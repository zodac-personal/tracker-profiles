...
public class NordicHdHandler extends AbstractTrackerHandler {
     ...
     *
     * <p>
     * For {@link NordicHdHandler}, there are multiple buttons for login. While only one of them has the value 'LOGIN', all of them seem to work, so
