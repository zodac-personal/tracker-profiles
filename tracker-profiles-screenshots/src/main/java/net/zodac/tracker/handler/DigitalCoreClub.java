...
public class DigitalCoreClub extends AbstractTrackerHandler {
     ...
     *
     * <p>
     * For {@link DigitalCoreClub}, prior to clicking the login button with a successful username/password there is another field where a
