...
public class YggTorrentHandler extends AbstractTrackerHandler {
     ...
     *
     * <p>
     * For {@link YggTorrentHandler}, after login there may be a pop-up offering a promotional sale on Turbo, which blocks the screen. We check for
