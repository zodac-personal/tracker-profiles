...
public class SocietyGlitchHandler extends AbstractTrackerHandler {
     ...
     *
     * <p>
     * For {@link SocietyGlitchHandler}, prior to clicking the login button with a successful username/password there is another field where a
