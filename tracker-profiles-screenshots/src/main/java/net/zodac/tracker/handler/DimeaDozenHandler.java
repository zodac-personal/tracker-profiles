...
/**
 * Implementation of {@link AbstractTrackerHandler} for the {@code DimeADozen} tracker.
 */
@TrackerHandler(name = "DimeADozen", url = "http://www.dimeadozen.org/")
public class DimeaDozenHandler extends AbstractTrackerHandler {
