...
public class AnimeBytes extends AbstractTrackerHandler {
     ...
     *
     * <p>
     * For {@link AnimeBytes}, after clicking the logout button, another button appears to confirm logout, which must be clicked.
     */
    @Override
    public void logout() {
