...
public class Orpheus extends GazelleHandler {
     ...
     *
     * <p>
     * For {@link Orpheus}, if the user has linked their {@code Last.fm} account, there is an element that loads the last played song, and this can
