...
/**
 * Extension of the {@link NexusPhpHandler} for the {@code LP-Bits} tracker.
 */
@TrackerHandler(name = "LP-Bits", type = TrackerType.MANUAL, url = "https://lp-bits.com/")
public class LpBits extends NexusPhpHandler {
