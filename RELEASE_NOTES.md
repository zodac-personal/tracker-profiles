...
I think the original variable name was a little ambiguous, so I'm making it a little clearer. The [README](README.md) still gives more details.
...
Added support for another 10 or so trackers.
